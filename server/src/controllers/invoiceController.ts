 ...
 */
export const getInvoicesByLead = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
 ...
 */
export const markInvoiceViewed = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
